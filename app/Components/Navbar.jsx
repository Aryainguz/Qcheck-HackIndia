  ...
  return (
    <nav className="flex-wrap lg:flex bg-black items-center w-[100%] m-auto py-4 px-10 rounded-b-[2rem]">
      <div className="flex items-center mb-10 lg:mb-0 w-1/4">
        <Link href="/">
          <h1 className="text-fuchsia-400 font-bold text-3xl">QCheck</h1>
        </Link>
        <button
          className="md:hidden w-10 h-10 ml-auto flex items-center justify-center border-blue-500 text-blue-500 rounded-md"
          onClick={() => setNavbarOpen(!navbarOpen)}
        >
          <h1 className="text-white bg-purple-500 w-16 font-bold text-3xl flex justify-center items-center absolute right-2 border-2 hover:bg-purple-500 hover:text-white border-purple-500 rounded-sm">
            &#8801;
          </h1>
        </button>
      </div>
      ...
      >
        <li className="font-semibold text-white hover:text-purple-500 transition ease-in-out duration-300 mb-5 lg:mb-0">
          <a href="#blockchain">
            BlockChain <span className="text-purple-500">trust</span>
          </a>
        </li>
        <li className="font-semibold text-white hover:text-purple-500 transition ease-in-out duration-300 mb-5 lg:mb-0">
          <a href="#industries">
