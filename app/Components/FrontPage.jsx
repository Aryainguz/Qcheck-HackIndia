        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mx-auto max-w-2xl lg:py-14">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gradient bg-gradient-to-r from-purple-500 to-green-300 bg-clip-text text-transparent  sm:text-6xl" data-aos="fade-in" >
                Blockchain Powered Assurance Securing Healthcare.
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600" data-aos="fade-up">
                VeriTrust uses power of blockchain technology to revolutionize whole supply chain industry of important medicines or products
              </p>
